...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="data_orang tua.php">Data Orang Tua</a>
            </li>
            <li class="nav-item">
  ...
  <div class="page-section">
    <div class="container">
      <h1 class="text-center wow fadeInUp">Data Anak</h1>
      <form class="contact-form mt-5" action="input_data.php" method="POST">
        <!-- <form class="contact-form mt-5"> -->
          ...
          <button type="submit" class="btn btn-primary wow zoomIn" name="tb_anak">Submit</button>
        </form>
      </div>
    </div>
      ...
      <form class="contact-form mt-5">
        <div class="row mb-3">
          <div class="col-12 py-2 wow fadeInUp">
            ...
            <input type="text" id="fullName" class="form-control" placeholder="Full name.." nama="nama_ibu">
          </div>
          <div class="col-12 py-2 wow fadeInUp">
            <label for="subject">NIK</label>
            <input type="number id="subject" class="form-control" placeholder="Enter subject.." nama="nik_ibu">
          </div>
          <div class="col-12 py-2 wow fadeInUp">
            <label for="subject">Tempat Lahir</label>
            <input type="text" id="subject" class="form-control" placeholder="Enter subject.." nama="tempat_lahir_ibu">
          </div>
          <div class="col-12 py-2 wow fadeInUp">
            <label for="subject">Tanggal Lahir</label>
            <input type="date" id="subject" class="form-control" placeholder="Enter subject.." nama="tanggal_lahir_ibu">
          </div>
          <div class="col-12 py-2 wow fadeInUp">
            <label for="subject">Jenis Kelamin</label>
            <input type="text" id="subject" class="form-control" placeholder="Enter subject.." nama="jenis_kelamin_ibu">
          </div>
          <div class="col-12 py-2 wow fadeInUp">
            <label for="subject">Alamat</label>
            <input type="text" id="subject" class="form-control" placeholder="Enter subject.." nama="alamat_ibu">
          </div>
