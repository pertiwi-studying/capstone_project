...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="data_anak_page.php">Data Anak</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="">Data Orang Tua</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="status_gizi_page.html">Status Gizi</a>
            </li>
          </ul>
        </div> <!-- .navbar-collapse -->
      </div> <!-- .container -->
  ...
  <div class="page-section">
    <div class="container">
      <h1 class="text-center wow fadeInUp">Rekomendasi Menu</h1>
...
mysqli_close($conn);
?>
   <p class="form-control">Rekomendasi menu : bubur ikan salmon dengan brokoli</p>   
    </div>
  </div>
</body>
</html>
